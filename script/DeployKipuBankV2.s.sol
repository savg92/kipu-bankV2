...
contract DeployKipuBankV2 is Script {
    ...
    function run() external returns (KipuBankV2) {
        ...
        console2.log("Max Withdraw Per TX:", MAX_WITHDRAW_PER_TX / 1 ether, "ETH");
        ...
        console2.log("   forge verify-contract", address(bank), "KipuBankV2 --chain sepolia");
        console2.log("2. Add supported ERC-20 tokens using addSupportedToken()");
